        ...
        for($x = 0; $x < $running_day; $x++)
        {
            ...
            if(isset($events[$today]) and count($events[$today]))
            {
                ...
                foreach($events[$today] as $event)
                {
                    ...
                    if($this->display_detailed_time and $this->main->is_multipleday_occurrence($event)) $events_str .= '<div class="mec-event-detailed-time mec-event-time m mec-color"><i class="mec-sl-clock-o"></i> '.MEC_kses::element($this->display_detailed_time($event)).'</div>';
                    elseif(trim($start_time)) $events_str .= '<div class="mec-event-time l mec-color"><i class="mec-sl-clock-o"></i> '.MEC_kses::element($start_time.(trim($end_time) ? ' - '.$end_time : '')).'</div>';
                    ...
                    $events_str .= '<div class="mec-event-detail xxx"><div class="mec-event-loc-place">'.(isset($location['name']) ? esc_html($location['name']) : '').'</div></div>';
                    ...
                    $events_str .= '<span class="b"></span></article>';
                }
        ...
        for($list_day = 1; $list_day <= $days_in_month; $list_day++)
        {
            ...
            if(isset($events[$today]) and count($events[$today]))
            {
                ...
                foreach($events[$today] as $event)
                {
                    ...
                    if($this->display_detailed_time and $this->main->is_multipleday_occurrence($event)) $events_str .= '<div class="mec-event-detailed-time mec-event-time x mec-color"><i class="mec-sl-clock-o"></i> '.MEC_kses::element($this->display_detailed_time($event)).'</div>';
                    elseif(trim($start_time)) $events_str .= '<div class="mec-event-time xs mec-color">'.wp_get_object_terms( $event->ID, 'mec_category', array( 'fields' => 'names' ) )[0].'</div>';
                    ...
                    if($this->localtime) $events_str .= MEC_kses::full($this->main->module('local-time.type3', array('event' => $event)));
                    $events_str .= '<div class="mec-event-detail aaa">';
                    $events_str .=  '<div class="mec-event-loc-place">'.esc_html((isset($location['name']) ? $location['name'] : '')).'</div>';
                    ...
                    $events_str .= MEC_kses::full($events_filter);
                    if ($str_format != '') {
                        $events_str .= '<div class="vdate"><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>'.$vdate.'</div>';
                    }
                    else {
                        $events_str .= '<div class="a"></div>';
                    }
                    ...
                    $events_str .= MEC_kses::full($events_filter);
                    $events_str .= '</div><div style="clear:both"></div><span class="c"></span></article>';
                }
            ...
            {
                echo '<dt class="mec-calendar-day '.esc_attr($selected_day).'" data-mec-cell="'.esc_attr($day_id).'" data-day="'.esc_attr($list_day).'" data-month="'.date('Ym', $time).'"><span>'.MEC_kses::full(apply_filters('mec_filter_list_day_value', $list_day, $today, $this)).'</span></dt>';
            ...
            for($x = 1; $x <= (8 - $days_in_this_week); $x++)
            {
                ...
                if(isset($events[$today]) and count($events[$today]))
                {
                    ...
                    foreach($events[$today] as $event)
                    {
                        ...
                        elseif(trim($start_time)) $events_str .= '<div class="mec-event-time s mec-color">'.wp_get_object_terms( $event->ID, 'mec_category', array( 'fields' => 'names' ) )[0].'</div>';
                        ...
                        if($this->localtime) $events_str .= MEC_kses::full($this->main->module('local-time.type3', array('event' => $event)));
                        $events_str .= '<div class="mec-event-detail sss"><div class="mec-event-loc-place">'.esc_html((isset($location['name']) ? $location['name'] : '')).'</div></div>';
                        $events_str .= MEC_kses::element($this->booking_button($event));
                        $events_str .= MEC_kses::embed($this->display_custom_data($event));
                        $events_str .= MEC_kses::element($this->display_cost($event));
                        ...
                        $events_str .= MEC_kses::full($events_filter);
                        if ($str_format != '') {
                            $events_str .= '<div class="vdate"><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>'.$vdate.'</div></article>';
                        }
                        else {
                            $events_str .= '<div class="a"></div></article>';
                        }
