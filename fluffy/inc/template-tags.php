...
function fluffy_posts_navigation($wp_query = NULL) {
	...
	echo '<div class="content-pagination"><div class="in-wrap-p"><a class="btn-pagina go-first" href="'.esc_url( get_pagenum_link( 1 ) ).'"><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><polyline points="11 17 6 12 11 7"></polyline><polyline points="18 17 13 12 18 7"></polyline></svg></a><div class="in-wrap">';
	$big = 9999999;
	...
	echo '</div><a class="go-last btn-pagina" href="'.esc_url( get_pagenum_link( $wp_query->max_num_pages ) ).'"><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><polyline points="13 17 18 12 13 7"></polyline><polyline points="6 17 11 12 6 7"></polyline></svg></a></div></div>';
}
