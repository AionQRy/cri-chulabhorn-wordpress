...
class post_tab_v4 extends Widget_Base
{
  ...
  public function __construct($data = [], $args = null)
  {
    ...
    // wp_enqueue_style('vc_post_tab_v4', plugin_dir_url(__DIR__) . '../css/post-tab/post-tab-v4.css', '1.1.0');
  }

  public function get_style_depends() {
    wp_register_style('vc_post_tab_v4', plugin_dir_url(__DIR__) . '../css/post-tab/post-tab-v4.css', '1.1.0');
    return [ 'vc_post_tab_v4' ];
  }
...
?>
        ...
        <div class="nav-sub-term-yp">
          <ul>
            ...
            ?>
              <li class="<?php if ($i == 1) {
                            echo "active";
                          } ?>" data-id="<?php echo $sub_term_id; ?>" data-nav="post-tab-v4">
  ...
  <div class="content-post-tab-yp	<?php if ($i == 1) { echo "active"; } ?>" data-id="<?php echo $term_id; ?>">
        <div class="vc_posts-wrapper post-s-list vc_post_tab_v4-s">
          ...
          <div class="vc_post_tab_v4 id-<?php echo $widget_id; ?>">
              <?php
              $args = [
                'post_type'      => ['post'],
                'tax_query'      => [
