...
class post_tab_v2 extends Widget_Base
{
  ...
  public function __construct($data = [], $args = null)
  {
    ...
    // wp_enqueue_style('vc_post_tab_v2', plugin_dir_url(__DIR__) . '../css/post-tab/post-tab-v2.css', '1.1.0');
  }
  public function get_style_depends() {
    wp_register_style('vc_post_tab_v2', plugin_dir_url(__DIR__) . '../css/post-tab/post-tab-v2.css', '1.1.0');
    return [ 'vc_post_tab_v2' ];
  }
...
?>
    ...
    <div class="vc_postx card post-tab-v2" data-nav="post-tab-v2">
      <div class="head-tab">
        ...
        <div class="nav-sub-term-yp">
          <ul>
            ...
            ?>
              <li class="<?php if ($i == 1) {
                            echo "active";
                          } ?>" data-id="<?php echo $sub_term_id; ?>" data-nav="post-tab-v2">
  ...
  <div class="content-post-tab-yp	<?php if ($i == 1) { echo "active"; } ?>" data-id="<?php echo $term_id; ?>">
        <div class="vc_posts-wrapper vc_post_tab_v2-s">

          <div class="swiper vc_post_tab_v2 id-<?php echo $widget_id; ?>">
        ...
        <?php if ($settings['pagination'] == 'yes'): ?>
          <div class="id-<?php echo $widget_id; ?> swiper-pagination"></div>
       <?php endif; ?>
        </div>
      </div>
      <?php endforeach; ?>
    ...
    <script type="module">
    var swiper = new Swiper(".vc_post_tab_v2.id-<?php echo $widget_id; ?>", {
